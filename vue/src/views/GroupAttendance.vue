<template>
  <div class="group-attendance-container">
    <h2 class="page-title">小组考勤情况</h2>
...
export default {
  ...
  methods: {
    ...
    async getGroupAttendance() {
      try {
        this.loading = true
        const response = await request.get('/attendance/groupAttendance', {
          params: {
            page: this.page,
